        ...
        <div id=navigation>
            <center>
                <ul>
                    ...
                    <li><a href="PostJob.action"><h3>JobPost</h3></a></li>
                    <li><a href="jobPost.action"><h3>ViewJob</h3></a></li>
            ...
            <center>
                ...
                <s:form action="searchjobrole"  >
                    ...
                    <s:if test="list1!=null">
                        <display:table class="displayTable" export="false" id="data" name="list1" requestURI="/searchjobrole.action" pagesize="5">

                            <display:column property="firstName" title="Name" />
                            
                            <display:column property="pgdegree" title="PG Degree" />
                            <display:column property="ugdegree" title="UG Degree" />                                
                            <display:column property="exporfre" title="Experience" />
                            <display:column property="expyears" title="Experience in Years" /> 
                            <display:column property="jobrole"  title="Applied Job Role"/> 
                            <display:column property="mobileNum" title="Contact" />                                
