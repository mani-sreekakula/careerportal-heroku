    ...
    <body>   
        ...
        <h3> Welcome <s:property value="#session.uname"/>&nbsp;&nbsp;&nbsp; User id: <s:property value="#session.userid"/> </h3>
            ...
            <div id="content">       
                <center>
                    <h1>JOB DETAILS:</h1>
                    <s:form action="viewjobsbyloc">
                    <table>
                        <tr>
                            <td>
                                 <s:select name="jobLocation" headerKey="1"  headerValue="-Please Select-"  label="Job Location" id="jobLocation" list="{'Chennai','Bengaluru','Hyderabad','Delhi','Mumbai','Kolkata'}" />
                            </td>
                        </tr>
                        <tr>
                            <td></td>
                  ...
                  <s:if test="list!=null">
                    <display:table class="displayTable" export="false" id="data" name="list" requestURI="/viewjobsbyloc.action" pagesize="5">
                    ...
                    <s:url action="moredetailsloc.action" id="urlTag">
